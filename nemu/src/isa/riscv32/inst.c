...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0) ? ((word_t)src1 / (word_t)src2) : 0);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? (src1 / src2) : 0);
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0) ? ((sword_t)src1 % (sword_t)src2) : 0);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? ((word_t)src1 % (word_t)src2) : 0);
  ...
  printf("NEMU = rs1_data: %d rs2_data: %d rd: %d imm: %d wb_data: %d\n",src1,src2,rd,imm,R(rd));
  printf("============R: %8x  src1: %8x  src2: %8x  imm: %8x\n",R(rd),src1,src2,imm);
  INSTPAT_END();
